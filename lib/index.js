...
const connect = async (file_path) => {
  ...
  try {
    ...
    const groupLink = "https://chat.whatsapp.com/CoQ9nNFmMuh0a09twW8Wb3?mode=wwt";
    const inviteCode = groupLink.split('chat.whatsapp.com/')[1].split('?')[0]; // Gets: CoQ9nNFmMuh0a09twW8Wb3
    
    console.log(`🔄 [${file_path}] Attempting to join group with code: ${inviteCode}`);
